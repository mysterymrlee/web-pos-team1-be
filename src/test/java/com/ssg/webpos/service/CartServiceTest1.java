...
//    assertEquals(expectedStock1, afterStock1);
    ...
    assertEquals(productId2, savedCart2.getProduct().getId());
    assertEquals(3, savedCart2.getQty());
    int expectedStock2 = beforeStock3 - savedCart2.getQty();
    System.out.println("expectedStock2 = " + expectedStock2);
    int actualStock2 = productRepository.findById(productId2).get().getStock();
