...
//    posId.setPos_id(1L);
//    posId.setStore_id(1L);
//    cartAddDTO1.setPosId(posId);
//    cartAddDTO1.setProductId(2L);
//    cartAddDTO1.setQty(3);
//
//    CartAddDTO cartAddDTO2 = new CartAddDTO();
//    PosId posId2 = new PosId();
//    posId2.setPos_id(1L);
//    posId2.setStore_id(1L);
//    cartAddDTO2.setPosId(posId);
//    cartAddDTO2.setProductId(3L);
//    cartAddDTO2.setQty(4);
//
//    CartAddDTO cartAddDTO3 = new CartAddDTO();
//    PosId posId3 = new PosId();
//    posId3.setPos_id(1L);
//    posId3.setStore_id(1L);
//    cartAddDTO3.setPosId(posId);
//    cartAddDTO3.setProductId(2L);
//    cartAddDTO3.setQty(3);
//
//
